...
export class ListarPensamentoComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.service.findAll(this.paginaAtual, this.filtro, this.favoritos).subscribe((listaPensamentos) => {
  ...
  public listarFavoritos(): void {
    ...
    this.paginaAtual = 1;
    this.service.findAll(this.paginaAtual,  this.filtro, this.favoritos).subscribe(listaPensamentosFavoritos => {
